...
Generated at: 2019-09-24T15:31:24+00:00
...
### files_comments_edit
> Edit an existing file comment.<br/>
...
* `page` - _optional_
* `types` - _optional_ - Filter files by type:<br/>
<br/>
* `all` - All files<br/>
* `spaces` - Posts<br/>
* `snippets` - Snippets<br/>
* `images` - Image files<br/>
* `gdocs` - Google docs<br/>
* `zips` - Zip files<br/>
* `pdfs` - PDF files<br/>
<br/>
You can pass multiple values in the types argument, like `types=spaces,snippets`.The default value is `all`, which does not filter the list.<br/>
